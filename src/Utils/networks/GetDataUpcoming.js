const GetDataUpcoming = async(number_page) => {
    
    const url = `https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=${number_page}`;
    const options = {
        method: 'GET',
        headers: {
...
export default GetDataUpcoming